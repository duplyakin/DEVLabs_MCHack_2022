 ...
 * @package App\Command
 */
class RememberNotifyLastCommand extends Command
{
    /**
     * @var string
     */
    protected static $defaultName = 'app:remember-notify-last';
    /**
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($communities as $community) {
            ...
            $event = (new NotificationEvent())
                ...
                ->setEventType(NotificationNode::EVENT_TYPE_UNREADY_BEFORE_CONNECT);
...
//        foreach ($communities as $community) {
//            $event = (new NotificationEvent())
//                ->setUsers($community->getUsers())
//                ->setTransports([
//                    TelegramBot::class,
//                    Email::class,
//                    TelegramNative::class,
//                ])
//                ->setEventType(NotificationNode::EVENT_TYPE_READY_BEFORE_CONNECT);
//            $this->eventDispatcher->dispatch($event);
//        }
