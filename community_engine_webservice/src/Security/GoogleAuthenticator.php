...
class GoogleAuthenticator extends SocialAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if ($existingUser) {
            //TODO
            if (!empty($credentials->getRefreshToken()) && empty($existingUser->getGoogleRefreshToken())) {
        ...
        if (!$user) {
            ...
            if ($googleUser->getAvatar()) {
                $user->setPicture(
                    $this->fileUploaderService->uploadFromUrl($googleUser->getAvatar())
                );
            }
        ...
        //TODO
        if (!empty($credentials->getRefreshToken()) && empty($user->getGoogleRefreshToken())) {
